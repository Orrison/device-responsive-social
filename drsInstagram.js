...
if(isIphone || isIpad) {
  setTimeout(function () { window.location = "https://www.instagram.com/rentyrentals/"; }, 5000); // Fallback in the event native app opening fails
  window.location = "instagram://user?username=[INSTAGRAM USERNAME HERE]"; // Opens IG link in iOS native app
} else if (isAndroid) {
  setTimeout(function () { window.location = "https://www.instagram.com/rentyrentals"; }, 25); // Fallback in the event native app opening fails
  ...
  window.location = "https://www.instagram.com/rentyrentals/"; // Defaults to opening link in the browser
}
